"""Phase 11 — full-history, multi-fold walk-forward validation.
...
OUT_DIR = Path(__file__).resolve().parents[2] / "docs" / "experiments" / "phase11_walkforward"
...
def main() -> None:
    ...
    record = {
        "experiment_id": "phase11_walkforward",
        "git_commit": commit,
...
def _report(record: dict) -> None:
    ...
    print("\n" + "=" * 150)
    print("PHASE 11 — FOLD-LEVEL OUT-OF-SAMPLE RESULTS")
    print("=" * 150)
